...
void GripPipeline::Process(cv::Mat& source0){
	...
	double rgbThresholdRed[] = {185.74640287769788, 255.0};
	double rgbThresholdGreen[] = {185.7464028776978, 255.0};
	double rgbThresholdBlue[] = {123.83093525179855, 255.0};
	...
	double filterContoursMinArea = 399.0;  // default Double
	double filterContoursMinPerimeter = 88.0;  // default Double
	double filterContoursMinWidth = 10.0;  // default Double
	double filterContoursMaxWidth = 145.0;  // default Double
	double filterContoursMinHeight = 21.0;  // default Double
	double filterContoursMaxHeight = 1000.0;  // default Double
	double filterContoursSolidity[] = {62.05035971223022, 100.0};
	double filterContoursMaxVertices = 20000.0;  // default Double
	double filterContoursMinVertices = 13.0;  // default Double
