package frc.robot.vision.doNotUse;
...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double filterContoursMinArea = 399.0;
		double filterContoursMinPerimeter = 88.0;
		double filterContoursMinWidth = 10.0;
		double filterContoursMaxWidth = 145.0;
		double filterContoursMinHeight = 21.0;
		double filterContoursMaxHeight = 1000.0;
		double[] filterContoursSolidity = {62.05035971223022, 100.0};
		double filterContoursMaxVertices = 20000.0;
		double filterContoursMinVertices = 13.0;
