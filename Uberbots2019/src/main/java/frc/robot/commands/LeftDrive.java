...
public class LeftDrive extends PIDCommand {
	 ...
	 */
	public LeftDrive(double setpoint) {
		super("LeftDrive", P, I, D);
		...
		startPoint = Robot.driveTrain.getLeftEncoderDistance();
	...
	protected boolean isFinished() {
		return Math.abs(Robot.driveTrain.getLeftEncoderDistance() - startPoint) <= SETPOINT_TOLERANCE;
    }
