...
public class RightDriveRate extends PIDCommand {
	 ...
	 */
	public RightDriveRate(double setpoint) {
		super("RightDriveRate", P, I, D);
		...
		startPoint = Robot.driveTrain.getRightEncoderRate();
	...
	protected boolean isFinished() {
		return Math.abs(Robot.driveTrain.getRightEncoderRate() - startPoint) <= SETPOINT_TOLERANCE;
    }
